//
//  main.cpp
//  reinforcementlearningseminar20181020
//
//  Created by Jinze YU on 2018/10/20.
//  Copyright © 2018 Jinze YU. All rights reserved.
//
...
int getRandomAction(int upperBound, int lowerBound){
    ...
    do {
        ...
        action = lowerBound + int((float) range * rand() / (RAND_MAX + 1.0));
